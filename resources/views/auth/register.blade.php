            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="class" class="col-md-4 col-form-label text-md-end">{{ __('クラス') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="attendance_number" class="col-md-4 col-form-label text-md-end">{{ __('出席番号') }}</label>

                            <div class="col-md-6">
                                <input id="attendance_number" type="text" class="form-control @error('attendance_number') is-invalid @enderror" name="attendance_number" value="{{ old('attendance_nubmer') }}" required autocomplete="attendance_number" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="role" class="col-md-4 col-form-label text-md-end">{{ __('タイプ') }}</label>
